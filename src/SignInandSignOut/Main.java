...
public class Main {
	public static void main(String[] args) {
		try {
			System.setIn(new FileInputStream("C:/Users/xxh/Desktop/workspace/PAT/src/SignInandSignOut/input.txt"));
		...
		System.out.print(mapIn.get(listIn.get(0))+" "+mapOut.get(listOut.get(listOut.size()-1)));
	}
}